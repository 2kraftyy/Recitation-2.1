...
public class SkillBuilder1 {
    public static void main(String[] args) {
        ...
        double spiceAns = (4.0 / 3.0) * Math.pow(2, Math.sqrt(5) / Math.pow(spice, 3));

        System.out.printf("Well %s, the spice value resulted in %.4f", name, spiceAns);
        double converted = (int)(spiceAns * 100) / 100.0;
        System.out.println("\nAnd the converted value is " + converted);
